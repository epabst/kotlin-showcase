    ...
    fun suite() {
        ...
        describe("TimerJS") {
            it("should serialize/deserialize") {
                ...
                val originalTimer = Timer("User #1", nowDateTime, 4, TimerType.VIDEO.name, 100, id = timerId)
            ...
            it("should serialize/deserialize as an Array") {
                val timer1 = Timer("User #1", nowDateTime, 4, TimerType.SONG.name, 101, id = ID(1234))
                val timer2 = Timer("User #2", nowDateTime, 8, TimerType.NONE.name, 102, id = ID(5678))
