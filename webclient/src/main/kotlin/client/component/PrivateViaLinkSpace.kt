...
fun Repository<PrivateViaLinkSpace>.populateSpaceIdAndCopyLinkToClipboard(accessProperty: Property<Access>, spaceName: ReadOnlyProperty<String>, destinationHash: String) {
...
fun BtsFormContext.accessControl(access: Property<Access>,
                                 ...
                                 privateViaLinkSpaceRepository: Repository<PrivateViaLinkSpace>): HTMLDivElement {
    return btsFormItemSimple(state = Property(State.Default), label = "Access Level") {
        ...
        btsButton(size = ButtonSize.Default, look = ButtonLook.Info,
                onclick = {
                    ...
                    privateViaLinkSpaceRepository.populateSpaceIdAndCopyLinkToClipboard(access, spaceName, destinationHash.get())
                    copied.set(true)
                }) {
