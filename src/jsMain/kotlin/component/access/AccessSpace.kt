package component.access

import component.firebase.FirebaseRepositorySync
import component.firebase.PrivatePathsSpecifier
//import component.firebase.FirebaseRepositorySync
//import component.firebase.PrivatePathsSpecifier
...
import component.repository.EmptyRepository
...
fun AccessJS.toNormal(): Access = Access(protectionLevel.name, privateViaLinkSpaceId?.toNormal()
        ?: accessSpaceId?.toNormal())

private val AccessJS.protectionLevel: ProtectionLevel
    get() {
...
class AccessSpaceModel(firebaseApp: App?) {
    val accessSpaceRepository = if (firebaseApp == null) {
        EmptyRepository<AccessSpace>() //todo .cached
    } else {
        val pathsSpecifier = PrivatePathsSpecifier<AccessSpace>("accessSpaceList", firebaseApp.auth())
