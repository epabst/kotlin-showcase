...
external interface Database<Content > : EventEmitter {
    var name: String
    fun allDocs(options: pouchdb.core.AllDocsWithKeyOptions = definedExternally /* null */): Promise<pouchdb.core.AllDocsResponse<Content /* Content & Model */>>
    fun allDocs(options: pouchdb.core.AllDocsWithKeysOptions = definedExternally /* null */): Promise<pouchdb.core.AllDocsResponse<Content /* Content & Model */>>
    fun allDocs(options: pouchdb.core.AllDocsWithinRangeOptions = definedExternally /* null */): Promise<pouchdb.core.AllDocsResponse<Content /* Content & Model */>>
    fun allDocs(options: pouchdb.core.AllDocsOptions = definedExternally /* null */): Promise<pouchdb.core.AllDocsResponse<Content /* Content & Model */>>
    fun bulkDocs(docs: Array<PostDocument<Content /* Content & Model */> /* NewDocument<Content /* Content & Model */> & ChangesMeta & `T$13` */>, options: pouchdb.core.BulkDocsOptions, callback: pouchdb.core.Callback<Array<dynamic /* PouchDB.Core.Response | PouchDB.Core.Error */>>)
    fun bulkDocs(docs: Array<PostDocument<Content /* Content & Model */> /* NewDocument<Content /* Content & Model */> & ChangesMeta & `T$13` */>, options: pouchdb.core.BulkDocsOptions = definedExternally /* null */): Promise<Array<dynamic /* PouchDB.Core.Response | PouchDB.Core.Error */>>
    ...
    fun get(docId: pouchdb.core.DocumentId, options: pouchdb.core.GetOptions, callback: pouchdb.core.Callback<Content /* Content & IdMeta */>)
    fun get(docId: pouchdb.core.DocumentId, options: pouchdb.core.GetOpenRevisions, callback: pouchdb.core.Callback<Array<pouchdb.core.Revision<Content /* Content & Model */>>>)
    fun get(docId: pouchdb.core.DocumentId, options: pouchdb.core.GetOptions = definedExternally /* null */): Promise<Content /* Content & IdMeta */>
    fun get(docId: pouchdb.core.DocumentId, options: pouchdb.core.GetOpenRevisions): Promise<Array<pouchdb.core.Revision<Content /* Content & Model */>>>
    fun post(doc: NewDocument<Content /* Content & Model */> /* NewDocument<Content /* Content & Model */> & `T$12` */, options: pouchdb.core.Options, callback: pouchdb.core.Callback<pouchdb.core.Response>)
    fun post(doc: NewDocument<Content /* Content & Model */> /* NewDocument<Content /* Content & Model */> & `T$12` */, options: pouchdb.core.Options = definedExternally /* null */): Promise<pouchdb.core.Response>
    fun put(doc: PostDocument<Content /* Content & Model */> /* NewDocument<Content /* Content & Model */> & ChangesMeta & `T$13` */, options: pouchdb.core.PutOptions, callback: pouchdb.core.Callback<pouchdb.core.Response>)
    fun put(doc: PostDocument<Content /* Content & Model */> /* NewDocument<Content /* Content & Model */> & ChangesMeta & `T$13` */, options: pouchdb.core.PutOptions = definedExternally /* null */): Promise<pouchdb.core.Response>
    ...
    fun changes(options: pouchdb.core.ChangesOptions, callback: pouchdb.core.Callback<pouchdb.core.Changes<Content /* Content & Model */>>)
    fun changes(options: pouchdb.core.ChangesOptions = definedExternally /* null */): pouchdb.core.Changes<Content /* Content & Model */>
    ...
    fun bulkGet(options: pouchdb.core.BulkGetOptions, callback: pouchdb.core.Callback<pouchdb.core.BulkGetResponse<Content /* Content & Model */>>)
    fun bulkGet(options: pouchdb.core.BulkGetOptions): Promise<pouchdb.core.BulkGetResponse<Content /* Content & Model */>>
    ...
    fun allDocs(): Promise<pouchdb.core.AllDocsResponse<Content /* Content & Model */>>
}