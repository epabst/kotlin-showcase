...
typealias PropsFromToggle = Partial<Pick<React.ComponentPropsWithRef<Any>, dynamic /* 'href' | 'size' | 'variant' | 'disabled' */>>
...
external open class DropdownButton : React.Component<ReplaceProps<Any, DropdownButtonProps>>